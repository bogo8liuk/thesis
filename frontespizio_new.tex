...
caratteristiche di langgg ed è possibile ritrovare la maggior parte di essere anche in Haskell. Un altro linguaggio
...
\item[Kind] Il linguaggio ha la nozione di \testit{kind} e permette la manipolazione di tipi di kind differenti.
