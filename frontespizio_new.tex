...
\node (desugar) [process, right of=prepare, xshift=5cm] {Desugaring};
\draw [arrow] (checker) -- (desugar);
\draw [arrow] (typedBuilder) -- (desugar);
\draw [arrow] (prepare) -- (desugar);
\draw [arrow] (typeInf) -- (desugar);
\draw [arrow] (CoreGen) -- (desugar);
\end{tikzpicture}
