...
Inoltre, il linguaggio target di Fex è \textit{Core}, un formalismo fortemente basato su \textit{System F}, una
...
puro), soprattutto per la sintassi di Fex e per il costrutto delle polymorphic variants (cfr. paragrafo sugli
sviluppi futuri).
