...
\subsection{Rimozione del pattern matching profondo}
...
\end{lstlisting}
Semanticamente, il codice relativo alla funzione \texttt{f} è equivalente a:
\begin{lstlisting}
let f x =
    match x with
          Nothing -> Just ServerError
...
\subsection{Unificazione degli scrutini}
