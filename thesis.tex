...
\[ free(Foo \; a1 \; a2 \; b) \nsubseteq free(\tau) \wedge free(Bar \; a1 \; a2) \subseteq free(\tau) \]
...
nel caso in cui vi siano due o più istanze che soddisfano un constraint. La scelta di langgg è quella di selezionare
l'istanza "più specializzata". Definiamo ora una relazione d'ordine parziale tra constraints, siano $ C $ e $ C' $ due
constraints:
\begin{itemize}
