...
per esempio, \texttt{read} e \texttt{write} per la lettura e la scrittura su file o \texttt{raise} per le eccezioni.
...
Nell'articolo [22] viene, innazitutto, fissato un linguaggio. L'aaproccio utilizzato qui è lo stesso, tuttavia, il
...
mantenendo divisi il "mondo puro" da quello "impuro".
