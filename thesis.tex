...
\begin{description}
\item[Linguaggio funzionale puro] Come Haskell, Fex è un linguaggio funzionale puro. La nozione di linguaggio
...
\item[Type-system statico con type-inference] Fex è un linguaggio con type-system statico, inoltre, la fase di
...
\item["Everything is an expression"] tutti i costrutti all'interno di Fex possono essere considerati espressioni
...
al contesto locale. I costrutti principali sono:
    ...
    seguenti proprietà:
        ...
        \end{enumerate}
    \end{enumerate}
\item[Tipi di dati algebrici] Fex supporta anche i tipi di dati algebrici (che sono l'unico modo per definire nuovi
...
\paragraph{Bozza di implementazione in Fex}
