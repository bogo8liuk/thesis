...
\paragraph{System-F}\hypertarget{System-F}
...
\subsection{Caratteristiche del linguaggio}\hypertarget{Caratteristiche del linguaggio}
...
\subsection{Il parser}\hypertarget{Il parser}
...
\subsubsection{Parsing degli operatori}\hypertarget{Parsing degli operatori}
...
\subsection{Check dei nomi}\hypertarget{Check dei nomi}
...
\subsection{Check degli argomenti}\hypertarget{Check degli argomenti}
...
\subsection{Prime fasi di desugaring}\hypertarget{Prime fasi di desugaring}
...
\subsubsection{Eliminazione delle firme di funzioni}\hypertarget{Eliminazione delle firme di funzioni}
...
\subsection{Approccio a tabelle}\hypertarget{Approccio a tabelle}
...
\subsubsection{Confronto con GHC}\hypertarget{Confronto con GHC}
...
\subsection{Il sistema di tipi}\hypertarget{Il sistema di tipi}
...
\subsubsection{Mono-tipo}\hypertarget{Mono-tipo}
...
\subsubsection{Tipi higher-kinded}\hypertarget{Tipi higher-kinded}
...
\subsubsection{Subtyping: predicati e tipi qualificati}\hypertarget{Subtyping: predicati e tipi qualificati}
...
\subsubsection{Schemi di tipo e polimorfismo parametrico}\hypertarget{Schemi di tipi e polimorfismo parametrico}
...
\subsubsection{Test di uguaglianza tra tipi}\hypertarget{Test di uguaglianza tra tipi}
...
\subsection{Polimorfismo ad-hoc}\hypertarget{Polimorfismo ad-hoc}
...
\subsection{Estensioni del polimorfismo ad-hoc}\hypertarget{Estensioni del polimorfismo ad-hoc}
...
\subsubsection{Numero arbitrario di argomenti delle proprietà}\hypertarget{Numero arbitrario di argomenti delle proprietà}
...
\subsubsection{Constraints sulle proprietà}\hypertarget{Constraints sulle proprietà}
...
\subsubsection{Polimorfismo higher-kinded}\hypertarget{Polimorfismo higher-kinded}
...
\subsubsection{Argomenti arbitrari delle istanze}\hypertarget{Argomenti arbitrari delle istanze}
...
\subsubsection{Constraints sulle istanze}\hypertarget{Constraints sulle istanze}
...
\subsection{Condizioni sui constraints}\hypertarget{Condizioni sui constraints}
...
\subsection{Kind-inference}\hypertarget{Kind-inference}
...
$ C $ avrà tipo (cfr \hyperlink{Data-constructors}):
...
\subsection{Data-constructors}\hypertarget{Data-constructors}
...
\subsection{Constraint constructors}\hypertarget{Constraint constructors}
...
\subsection{Costruzione delle istanze}\hypertarget{Costruzione delle istanze}
...
\hyperlink{Constraints sulle proprietà}). Prima di inserire i bindings delle istanze nella
...
\subsection{Preparazione alla type-inference}\hypertarget{Preparazione alla type-inference}
...
\subsubsection{Bindings delle istanze}\hypertarget{Bindings delle istanze}
...
\subsubsection{Simboli innestati univoci}\hypertarget{Simboli innestati univoci}
...
\subsubsection{Clusters di definizioni mutualmente ricorsive}\hypertarget{Clusters di definizioni mutualmente ricorsive}
...
\subsubsection{Sorting dei bindings}\hypertarget{Sorting dei bindings}
...
\subsection{Type-inference}\hypertarget{Type-inference}
...
(cfr. \hyperlink{Schemi di tipi e polimorfismo parametrico}{Schemi di tipi e polimorfismo parametrico}), la variabile di
...
\subsubsection{Damas-Hindley-Milner}\hypertarget{Damas-Hindley-Milner}
...
\subsubsection{Inferenza di variabile}\hypertarget{Inferenza di variabile}
...
\subsubsection{Inferenza di applicazione}\hypertarget{Inferenza di applicazione}
...
\subsubsection{Unificazione}\hypertarget{Unificazione}
...
\subsubsection{Inferenza di lambda astrazione}\hypertarget{Inferenza di lambda astrazione}
...
\subsubsection{Inferenza del costrutto "let..in"}\hypertarget{Inferenza del costrutto "let..in"}
...
\subsubsection{Implementazione delle regole di inferenza}\hypertarget{Implementazione delle regole di inferenza}
...
\paragraph{Lambda-astrazione in Fex}\hypertarget{Lambda-astrazione in Fex}
...
\paragraph{Simboli globali in Fex}\hypertarget{Simboli globali in Fex}
...
\paragraph{Costrutto "let..in" in Fex}\hypertarget{Costrutto "let..in" in Fex}
...
\subsection{Estensioni dell'algoritmo di inferenza}\hypertarget{Estensioni dell'algoritmo di inferenza}
...
\subsubsection{Pattern matching}\hypertarget{Pattern matching}
...
\paragraph{Eliminazione del pattern matching "in larghezza"}\hypertarget{Eliminazione del pattern matching "in larghezza"}
...
\subsubsection{Constraints}\hypertarget{Constraints}
...
\paragraph{Normalizzazione}\hypertarget{Normalizzazione}
...
\paragraph{Confronto con Haskell}\hypertarget{Confronto con Haskell}
...
\subsubsection{Type-hinting}\hypertarget{Type-hinting}
...
\subsubsection{Ricorsione}\hypertarget{Ricorsione}
...
\section{Generazione del codice}\hypertarget{Generazione del codice}
...
\subsection{Fasi di desugaring}\hypertarget{Fasi di desugaring}
...
\subsubsection{Dispatch statico}\hypertarget{Dispatch statico}
...
\subsubsection{Lambda-astrazione}\hypertarget{Lambda-astrazione}
...
\subsubsection{Rimozione del pattern matching profondo}\hypertarget{Rimozione del pattern matching profondo}
...
\subsubsection{Unificazione degli scrutini}\hypertarget{Unificazione degli scrutini}
...
\subsection{Generazione del codice Core}\hypertarget{Generazione del codice Core}
...
\paragraph{Traduzione dei tipi e dei costruttori}\hypertarget{Traduzione dei tipi e dei costruttori}
...
\subsection{Back-end}\hypertarget{Back-end}
...
\section{Sviluppi futuri}\hypertarget{Sviluppi futuri}
...
\subsection{Tipi lineari}\hypertarget{Tipi lineari}
...
\subsection{Effetti}\hypertarget{Effetti}
...
un tipo qualificato (cfr. \hyperlink{Schemi di tipi e polimorfismo parametrico}{Schemi di tipi e polimorfismo parametrico})
...
\subsection{Varianti polimorfe}\hypertarget{Varianti polimorfe}
...
\begin{enumerate}[label={[\arabic*]}]
    ...
    Mathematical Society, 146, 29–60. - url: \url{https://doi.org/10.2307/1995158}
    %[28]
