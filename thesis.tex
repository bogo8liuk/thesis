...
\begin{enumerate}
    \item $ \forall \; constraint =: c.\; \exists \; tyvar =: v.\; v \in c $
    \item $ \forall \; instance =: c \Rightarrow h.\; \forall \; tyvar =: v.\; v \in instance \Longrightarrow
    occ(v, c) \leq occ(v, h) $
    \item $ \forall \; instance =: c \Rightarrow h.\; countWrapVars(c) < countWrapVars(h) $
\end{enumerate}
