...
\[ C, \Gamma \vdash_W foo : a1 \mapsto a2 \mapsto a3 \mapsto Char \]
...
nel contesto è $ Foo \; a1 \; a2 \; a3 $ e il mono-tipo da generalizzare associato \texttt{f} è
$ \tau = a1 \mapsto a2 \mapsto a3 \mapsto Char $.
%TODO
il constraint può essere aggiunto allo schema di tipo che verrà generato. \texttt{f} avrà, quindi, il seguente tipo:
