...
Innanzitutto, è bene notare come in Core non esista un costrutto particolare per i bindings delle istanze, inoltre, il
...
aggiungerli nell'insieme di bindings da dare in input all'algoritmo di type-inference. Tuttavia, data una proprietà,
può esistere un numero arbitrario di istanze e con esse, un numero arbitrario di metodi con lo stesso nome. Questo
problema viene già gestito (cfr. Costruzione delle istanze)
