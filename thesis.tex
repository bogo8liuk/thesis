...
\hyperlink{bibl31}{[31]}, OCaml, largamente utilizzato da Facebook in molti dei suoi software come Hack
...
pattern matching per Python e Rust, il costrutto di lambda-astrazione per PHP, Python, C# e JavaScript, le funzioni
come "cittadini di prima classe" per Python, JavaScript e Go, etc..
