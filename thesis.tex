...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item per quanto riguarda le espressioni $ e_j $, non sempre nei casi precedenti si riesce ad inferire il tipo più
        specializzato tra tutte le espressioni $ e_j $;
    \end{enumerate}
...
le varianti polimorfe (il loro identificatore è preceduto dal carattere \` ).
