...
infatti, senza le varianti polimorfe, sarebbe necessario costruire l'astrazione giusta per "far comunicare" le
librerie nel modo giusto, utilizzando un attore di terze parti che funga da interfaccia comune tra le librerie coinvolte.
Invece, l'utilizzo con le varianti polimorfe, è possibile definire lo stesso tipo nelle librerie coinvolte, permettendo
