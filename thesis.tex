...
\begin{enumerate}
    ...
    \item trova una sottolista \textit{l} in cui tutti gli elementi sono uguali a \textit{x}; in questo caso, \texttt{x}
    viene inserito in \textit{l}.
\end{enumerate}
