...
dell'effetto. Questo fatto permette di catturare precisamente i side-effects prodotti dalle operazioni.
...
In questo caso, è necessario un'analisi statica specifica, infatti, l'unico "costrutto" che permette la divergenza è la
ricorsione, quindi, ogni qual volta vi sono uno o più bindings ricorsivi, il loro tipo può essere l'effetto divergenza.
...
side-effects potrebbe dipendere da come viene "compilata" la monade IO. In ogni caso, è necessario un \textit{mapping}
